...
import org.example.hashalgorithms.HashAlgorithm;
import org.example.hashalgorithms.SHA256;
import org.example.sigalgorithms.EllipticCurve;
import org.example.sigalgorithms.KeyPair;
...
public class RingSignatureService {
    ...
    public Signature signMessage(String message, KeyPair personalKeys,
        ...
        List<ECPoint> lArray = new ArrayList<ECPoint>();
        List<ECPoint> rArray = new ArrayList<ECPoint>();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ringSignatureService.verifySignature(message, signature, publicKeys));
    }
}