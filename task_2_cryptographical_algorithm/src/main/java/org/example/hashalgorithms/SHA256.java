...
public class SHA256 implements HashAlgorithm{
    ...
    public static String hash(byte[] message) {
        ...
        String result = Integer.toHexString(H[0]) + Integer.toHexString(H[1]) + Integer.toHexString(H[2]) +
                Integer.toHexString(H[3]) + Integer.toHexString(H[4]) + Integer.toHexString(H[5]) +
                Integer.toHexString(H[6]) + Integer.toHexString(H[7]);
    ...
    public static void main(String[] args) {
        HashAlgorithm hashFunction = new SHA256();
